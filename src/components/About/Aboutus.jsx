                        ...
                        <div className="row">
                            <div className="col-xl-6 offset-xl-6">
                                <div className="about__content-wrapper pt-20 pl-85">
                                    ...
                                    <p>Мы практикующие психологи со степенью магистра в области системной семейной
                                        психотерапии.</p>
                                    ...
                                    <div className="about__info-2 d-sm-flex mb-60">
                                        ...
                                        <p>Мы - авторы и ведущие тренинга
                                            ...
                                            результаты которого научно подтверждены и были представлены на нескольких
                                            международных научно-практических конференциях.</p>
                                    </div>
                            ...
                            <div className="col-xl-7 col-lg-7">
                                <div className="testimonial__wrapper testimonial__wrapper-3 pt-50 pb-35">
                                    <div className="section__title mb-20">
                                        <div className="section__icon mb-10">
                                            <span
                                                className="section__sub-title section__sub-title-2 section__sub-title-3"></span>
                                        </div>
