						...
						<div className ='row'>
							<div className ='col-xl-2 col-lg-3 col-md-4 col-sm-6 col-8'>
								<div className ='logo-2'>
									<a href='index-2.html'>< img src={logo}></ img></a>
								</div>
							</div>
							<div className ='col-xl-10 col-lg-9 col-md-8 col-sm-6 col-4'>
								<div className ='header__bottom-right pink-soft-bg d-flex justify-content-end justify-content-lg-between align-items-center'>
									<div className ='main-menu main-menu-2 d-none d-lg-block'>
										<nav>
											<ul>
												...
												{/* <li><a href="case.html">Почему стоит выбрать нас</a>
                                                <ul className  ="submenu">
									...
									<div className ='header__btn d-none d-xl-block'>
										<a href='contact.html' className ='s-btn s-btn__square'>
											Записаться
										</a>
									</div>
								</div>
